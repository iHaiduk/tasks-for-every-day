## Задачі
- [Задача №16 (про оператори та їх пріоритет)](#задача-16-про-оператори-та-їх-пріоритет)
- Принципи
...
- [Задача №11 (про генератори)](#задача-11-про-генератори)
- [Задача №10 (про замикання)](#задача-10-про-змикання)
- [Задача №9 (про чисті словники)](#задача-9-про-чисті-словники)
- [Задача №8 (про асинхроннe програмування частина 3)](#задача-8-про-асинхроннe-програмування-частина-3)
- [Задача №7 (про IIFE)](#задача-7-про-iife)
- [Задача №6 (про рест-параметри)](#задача-6-про-рест-параметри)
- [Задача №5 (про асинхроннe програмування частина 2)](#задача-5-про-асинхроннe-програмування-частина-2)
- [Задача №4 (про асинхроннe програмування частина 1)](#задача-4-про-асинхроннe-програмування-частина-1)
- [Задача №3 (про області видимості змінних)](#задача-3-про-області-видимості-змінних)
- [Задача №2 (про this)](#задача-2-про-this)
- [Задача №1 (про підняття / hoisting)](#задача-1-про-підняття-hoisting)
---

### Задача №16 (про оператори та їх пріоритет)
...
### Задача №8 (про асинхроннe програмування частина 3)
...
### Задача №5 (про асинхроннe програмування частина 2)
...
### Задача №4 (про асинхроннe програмування частина 1)
...
### Задача №3 (про області видимості змінних)
...
### Задача №1 (про підняття / hoisting)
